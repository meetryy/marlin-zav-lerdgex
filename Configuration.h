...
#define STRING_CONFIG_H_AUTHOR "meetry" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 79.97
  #define DEFAULT_bedKi 14.08
  #define DEFAULT_bedKd 302.82
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, 10, -3 }
